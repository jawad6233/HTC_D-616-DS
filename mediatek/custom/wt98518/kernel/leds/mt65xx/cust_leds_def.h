...
/*customize the lcd backlight max and min level*/
#define LED_OUTPUT_MAX_LEVEL     255 // Range :  1  ~ 255 , Default : 255;   
#define LED_OUTPUT_MIN_LEVEL     26 // Range :  1  ~ 255 , Default: 30;   
