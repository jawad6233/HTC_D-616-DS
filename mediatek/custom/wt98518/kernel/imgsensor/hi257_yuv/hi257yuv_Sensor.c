...
HI257WriteCmosSensor(0x01, 0x01); //sleep on
	...
	HI257WriteCmosSensor(0x09, 0x37);		// pad strength = max
	HI257WriteCmosSensor(0x0a, 0x06);		// pad strength = max
...
HI257WriteCmosSensor(0x41, 0x78); 
	...
	HI257WriteCmosSensor(0x84, 0xcc);
	...
	HI257WriteCmosSensor(0x10, 0x03);  //S2D enable _ YUYV Order o?????
...
HI257WriteCmosSensor(0x40, 0x00);
	HI257WriteCmosSensor(0x41, 0x10); //D-YOffset Th
...
HI257WriteCmosSensor(0x60, 0x4f);
	HI257WriteCmosSensor(0x61, 0x9c);//Sat B//0xa0  
	HI257WriteCmosSensor(0x62, 0x9a);//Sat R//0xa0
HI257WriteCmosSensor(0x63, 0xa0); //Auto-De Color

	HI257WriteCmosSensor(0x66, 0x42);
HI257WriteCmosSensor(0x67, 0x23);

HI257WriteCmosSensor(0x6a, 0x5b); //White Protection Offset Dark/Indoor
	...
	//LPF Auto Control
	HI257WriteCmosSensor(0x20, 0x20);
	...
	HI257WriteCmosSensor(0x80, 0xfd);  //Sharp2D enable _ YUYV Order o?????
	...
	HI257WriteCmosSensor(0x20, 0x60);
	HI257WriteCmosSensor(0x21, 0x5c);

	HI257WriteCmosSensor(0x22, 0x1d);
	HI257WriteCmosSensor(0x23, 0x14);
	HI257WriteCmosSensor(0x24, 0x13);
...
//CMC
	...
	HI257WriteCmosSensor(0x80, 0x00); 
	HI257WriteCmosSensor(0x85, 0x80); 
	HI257WriteCmosSensor(0x87, 0x02); 
	HI257WriteCmosSensor(0x88, 0x00); 
	HI257WriteCmosSensor(0x89, 0x00); 
	HI257WriteCmosSensor(0x8a, 0x00);
	///// PAGE 15 END /////
...
HI257WriteCmosSensor(0x34, 0x53);
...
HI257WriteCmosSensor(0x51, 0x06);
HI257WriteCmosSensor(0x52, 0x12);
HI257WriteCmosSensor(0x53, 0x29);
HI257WriteCmosSensor(0x54, 0x45);
HI257WriteCmosSensor(0x55, 0x60);
HI257WriteCmosSensor(0x56, 0x7a);
HI257WriteCmosSensor(0x57, 0x8e);
HI257WriteCmosSensor(0x58, 0xa1);
...
HI257WriteCmosSensor(0x75, 0x6c);
HI257WriteCmosSensor(0x76, 0x81);
HI257WriteCmosSensor(0x77, 0x94);
HI257WriteCmosSensor(0x78, 0xa4);
HI257WriteCmosSensor(0x79, 0xb3);
HI257WriteCmosSensor(0x7a, 0xc0);
HI257WriteCmosSensor(0x7b, 0xcb);
HI257WriteCmosSensor(0x7c, 0xd5);
HI257WriteCmosSensor(0x7d, 0xde);
HI257WriteCmosSensor(0x7e, 0xe8);
HI257WriteCmosSensor(0x7f, 0xef);
HI257WriteCmosSensor(0x80, 0xf5);
...
HI257WriteCmosSensor(0x10, 0x7f); //mcmc_ctl1
...
HI257WriteCmosSensor(0x15, 0xa5); //mcmc_center2
...
HI257WriteCmosSensor(0x1f, 0x5d); //mcmc_sat_gain2
HI257WriteCmosSensor(0x20, 0x6f); //mcmc_sat_gain3
HI257WriteCmosSensor(0x21, 0x37); //mcmc_sat_gain4
HI257WriteCmosSensor(0x22, 0x59); //mcmc_sat_gain5
HI257WriteCmosSensor(0x23, 0x48); //mcmc_sat_gain6
HI257WriteCmosSensor(0x24, 0x00); //mcmc_hue_angle1
HI257WriteCmosSensor(0x25, 0x8c); //mcmc_hue_angle2
...
HI257WriteCmosSensor(0x6c, 0xff); //mcmc_lum_ctl1
HI257WriteCmosSensor(0x6d, 0x3f); //mcmc_lum_ctl2
HI257WriteCmosSensor(0x6e, 0x00); //mcmc_lum_ctl3
HI257WriteCmosSensor(0x6f, 0x00); //mcmc_lum_ctl4
HI257WriteCmosSensor(0x70, 0x00); //mcmc_lum_ctl5
HI257WriteCmosSensor(0x71, 0x3f); //rg1_lum_gain_wgt_th1
HI257WriteCmosSensor(0x72, 0x3f); //rg1_lum_gain_wgt_th2
HI257WriteCmosSensor(0x73, 0x3f); //rg1_lum_gain_wgt_th3
HI257WriteCmosSensor(0x74, 0x3f); //rg1_lum_gain_wgt_th4
HI257WriteCmosSensor(0x75, 0x30); //rg1_lum_sp1
HI257WriteCmosSensor(0x76, 0x50); //rg1_lum_sp2
HI257WriteCmosSensor(0x77, 0x80); //rg1_lum_sp3
HI257WriteCmosSensor(0x78, 0xb0); //rg1_lum_sp4
HI257WriteCmosSensor(0x79, 0x3f); //rg2_gain_wgt_th1
HI257WriteCmosSensor(0x7a, 0x3f); //rg2_gain_wgt_th2
HI257WriteCmosSensor(0x7b, 0x3f); //rg2_gain_wgt_th3
HI257WriteCmosSensor(0x7c, 0x3f); //rg2_gain_wgt_th4
HI257WriteCmosSensor(0x7d, 0x28); //rg2_lum_sp1
HI257WriteCmosSensor(0x7e, 0x50); //rg2_lum_sp2
HI257WriteCmosSensor(0x7f, 0x80); //rg2_lum_sp3
HI257WriteCmosSensor(0x80, 0xb0); //rg2_lum_sp4
HI257WriteCmosSensor(0x81, 0x28); //rg3_gain_wgt_th1
HI257WriteCmosSensor(0x82, 0x3f); //rg3_gain_wgt_th2
HI257WriteCmosSensor(0x83, 0x3f); //rg3_gain_wgt_th3
HI257WriteCmosSensor(0x84, 0x3f); //rg3_gain_wgt_th4
HI257WriteCmosSensor(0x85, 0x28); //rg3_lum_sp1
HI257WriteCmosSensor(0x86, 0x50); //rg3_lum_sp2
HI257WriteCmosSensor(0x87, 0x80); //rg3_lum_sp3
HI257WriteCmosSensor(0x88, 0xb0); //rg3_lum_sp4
HI257WriteCmosSensor(0x89, 0x1a); //rg4_gain_wgt_th1
HI257WriteCmosSensor(0x8a, 0x28); //rg4_gain_wgt_th2
HI257WriteCmosSensor(0x8b, 0x3f); //rg4_gain_wgt_th3
HI257WriteCmosSensor(0x8c, 0x3f); //rg4_gain_wgt_th4
HI257WriteCmosSensor(0x8d, 0x10); //rg4_lum_sp1
HI257WriteCmosSensor(0x8e, 0x30); //rg4_lum_sp2
HI257WriteCmosSensor(0x8f, 0x60); //rg4_lum_sp3
HI257WriteCmosSensor(0x90, 0x90); //rg4_lum_sp4
HI257WriteCmosSensor(0x91, 0x1a); //rg5_gain_wgt_th1
HI257WriteCmosSensor(0x92, 0x28); //rg5_gain_wgt_th2
HI257WriteCmosSensor(0x93, 0x3f); //rg5_gain_wgt_th3
HI257WriteCmosSensor(0x94, 0x3f); //rg5_gain_wgt_th4
HI257WriteCmosSensor(0x95, 0x28); //rg5_lum_sp1
HI257WriteCmosSensor(0x96, 0x50); //rg5_lum_sp2
HI257WriteCmosSensor(0x97, 0x80); //rg5_lum_sp3
HI257WriteCmosSensor(0x98, 0xb0); //rg5_lum_sp4
HI257WriteCmosSensor(0x99, 0x1a); //rg6_gain_wgt_th1
HI257WriteCmosSensor(0x9a, 0x28); //rg6_gain_wgt_th2
HI257WriteCmosSensor(0x9b, 0x3f); //rg6_gain_wgt_th3
HI257WriteCmosSensor(0x9c, 0x3f); //rg6_gain_wgt_th4
HI257WriteCmosSensor(0x9d, 0x28); //rg6_lum_sp1
HI257WriteCmosSensor(0x9e, 0x50); //rg6_lum_sp2
HI257WriteCmosSensor(0x9f, 0x80); //rg6_lum_sp3
HI257WriteCmosSensor(0xa0, 0xb0); //rg6_lum_sp4
HI257WriteCmosSensor(0xa1, 0x00); //mcmc_allgain_ctl
	...
	HI257WriteCmosSensor(0x70, 0x52);
	HI257WriteCmosSensor(0x71, 0x85); //81(+4),89(-4)
	...
	HI257WriteCmosSensor(0x9c, 0x21); //EXP Limit 764.71 fps 
	HI257WriteCmosSensor(0x9d, 0x34); 
...
HI257WriteCmosSensor(0x9c, 0x88);
...
HI257WriteCmosSensor(0x03, 0x11);
HI257WriteCmosSensor(0x20, 0x2a);
...
HI257WriteCmosSensor(0xa5, 0x13); //EXP Max 50hz 16.67 fps 
...
HI257WriteCmosSensor(0x80,0xfd);
	spin_lock(&hi257_drv_lock);
  HI257Status.PvDummyPixels = 360;
  last_central_p_x = 2; 
  last_central_p_y = 2;
...
HI257WriteCmosSensor(0x03,0x20);
HI257WriteCmosSensor(0x10,0x1c);
current_exposure_line=(HI257ReadCmosSensor(0x80)<<16)|(HI257ReadCmosSensor(0x81)<<8)|HI257ReadCmosSensor(0x82);
Max_exposure_line=(HI257ReadCmosSensor(0x88)<<16)|(HI257ReadCmosSensor(0x89)<<8)|HI257ReadCmosSensor(0x8a);
if(current_exposure_line<Max_exposure_line)
	{
		HI257WriteCmosSensor(0x03,0x11);
    HI257WriteCmosSensor(0x20,0x2a);
	}
...
HI257WriteCmosSensor(0x18, 0x38); //AE Reset On
	...
	HI257WriteCmosSensor(0x88, 0x08); //EXP Max 60hz 12.00 fps 
	HI257WriteCmosSensor(0x89, 0x3d); 
	HI257WriteCmosSensor(0x8a, 0x60); 

	HI257WriteCmosSensor(0xa5, 0x07); //EXP Max 50hz 12.50 fps 
...
HI257WriteCmosSensor(0x18, 0x38); //AE Reset On
	...
	HI257WriteCmosSensor(0x88, 0x0c); //EXP Max 60hz 8.00 fps 
	HI257WriteCmosSensor(0x89, 0x5c); 
	HI257WriteCmosSensor(0x8a, 0x10); 
	HI257WriteCmosSensor(0xa5, 0x0b); //EXP Max 50hz 8.33 fps 
...
HI257WriteCmosSensor(0x18, 0x38); //AE Reset On
	...
	HI257WriteCmosSensor(0x88, 0x04); //EXP Max 60hz 20.00 fps 
	HI257WriteCmosSensor(0x89, 0xf1); 
	HI257WriteCmosSensor(0x8a, 0xa0); 
	HI257WriteCmosSensor(0xa5, 0x04); //EXP Max 50hz 20.00 fps 
...
HI257WriteCmosSensor(0x60, 0x4f);
	HI257WriteCmosSensor(0x61, 0x9c); //Sat B
	HI257WriteCmosSensor(0x62, 0x9a); //Sat R
HI257WriteCmosSensor(0x63, 0xa0); //Auto-De Color
...
//HI257WriteCmosSensor(0x03, 0x00);
//HI257WriteCmosSensor(0x50, 0x04);
break;
...
else if (HI257Status.Banding == AE_FLICKER_MODE_OFF)
	{
		HI257WriteCmosSensor(0x03, 0x20); //Page 20
    HI257WriteCmosSensor(0x10, 0x9c);
  }
...
void HI257set_contrast(UINT16 para)
{
  ...
  HI257SetPage(0x10);  
	...
	//Med
	HI257WriteCmosSensor(0x03, 0x10);
	HI257WriteCmosSensor(0x48, 0x88); 
...
void HI257set_saturation(UINT16 para)
{
	...
	//Hig
	HI257WriteCmosSensor(0x03, 0x10);
	HI257WriteCmosSensor(0x61, 0xc8); //Sat B
	HI257WriteCmosSensor(0x62, 0xc8); //Sat R
	...
	HI257WriteCmosSensor(0x62, 0xb0); // SATR
...
HI257WriteCmosSensor(0x2b, 0x35);
	...
	HI257WriteCmosSensor(0x88, 0x0c); //EXP Max 60hz 10.00 fps 
	HI257WriteCmosSensor(0x89, 0x5c); 
	HI257WriteCmosSensor(0x8a, 0x10); 
	HI257WriteCmosSensor(0xa5, 0x0c); //EXP Max 50hz 10.00 fps 
	HI257WriteCmosSensor(0xa6, 0x5c); 
	HI257WriteCmosSensor(0xa7, 0x10); 

	HI257WriteCmosSensor(0x91, 0x06); //EXP Fix 10.00 fps
...
HI257WriteCmosSensor(0x2b, 0x35);
	...
	HI257WriteCmosSensor(0x89, 0xf1); 
	HI257WriteCmosSensor(0x8a, 0xa0); 
	HI257WriteCmosSensor(0xa5, 0x04); //EXP Max 50hz 20.67 fps 
HI257WriteCmosSensor(0xa6, 0xf5); 
HI257WriteCmosSensor(0xa7, 0x88); 

	HI257WriteCmosSensor(0x91, 0x02); //EXP Fix 19.01 fps
...
//flashTrigger
#define FLASH_BV_THRESHOLD 0x45 //0x3f//0x48
static void HI257FlashTriggerCheck(unsigned int *pFeatureReturnPara32)
{
    int NormBr;
    printk("HI253FlashTriggerCheck start \n");
    HI257WriteCmosSensor(0x03, 0x20);
    HI257WriteCmosSensor(0x10, 0x9C);
    NormBr = HI257ReadCmosSensor(0xb0);
    printk("[HI257][HI257FlashTriggerCheck]NormBr=%d \n",NormBr);
                        ...
                        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
  ...
  switch (FeatureId)
  {
    ...
    case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO:
	  HI257FlashTriggerCheck(pFeatureData32);
         SENSORDB("HI257FeatureControl:SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO \n");
	break;
