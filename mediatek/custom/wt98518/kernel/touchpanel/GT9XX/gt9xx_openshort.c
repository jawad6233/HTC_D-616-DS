 ...
 * Version:1.0.1
 * Accomplished Date:2014/03/25
 * Revision record:
        send config for TP test 
 */
...
// open test
//#define DEFAULT_TEST_ITEMS  (_MAX_TEST | _MIN_TEST | _KEY_MAX_TEST | _KEY_MIN_TEST) //Have virtual key
#define DEFAULT_TEST_ITEMS  (_MAX_TEST | _MIN_TEST)    //No virtual key  

//TODO: define your own default or for Sensor_ID == 0 config here. 
//O-film 
#define MAX_LIMIT_VALUE_GROUP1 2400 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP1 1300		// screen min limit
#define MAX_LIMIT_KEY_GROUP1 2400		// key_val max limit
#define MIN_LIMIT_KEY_GROUP1 1300		// key_val min limit
#define UNIFORMITY_GROUP1 60 			// screen uniformity in percent

#define CTP_TEST_CFG_GROUP1 {\
0x00,0xD0,0x02,0x00,0x05,0x05,0x04,0x00,\
0x01,0x0B,0x14,0x0F,0x37,0x28,0x03,0x05,\
0x00,0x00,0x00,0x00,0x11,0x00,0x04,0x18,\
0x1A,0x1E,0x14,0x8C,0x0B,0x0D,0x64,0x00,\
0xED,0x06,0x00,0x00,0x01,0xBA,0x02,0x1D,\
...
0x16,0x00,0x02,0x04,0x06,0x08,0x0A,0x0C,\
0x0F,0x10,0x12,0x13,0x14,0xFF,0xFF,0xFF,\
0x00,0x00,0x00,0x11,0x11,0x11,0x11,0x11,\
0x11,0x11,0x11,0x11,0x11,0x01,0xFF,0xFF,\
0x9F,0x01\
    }

//TODO: define your config for Sensor_ID == 1 here, if needed

#define MAX_LIMIT_VALUE_GROUP2 2400 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP2 1300		// screen min limit
...
#define MAX_LIMIT_VALUE_GROUP6 2704 	// screen max limit
#define MIN_LIMIT_VALUE_GROUP6 1329		// screen min limit
...
0x00,0xD0,0x02,0x00,0x05,0x0A,0x04,0x00,\
0x01,0x08,0x28,0x0A,0x50,0x32,0x03,0x05,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x8C,0x2B,0x0D,0x2C,0x2A,\
0x31,0x0D,0x00,0x00,0x02,0xBA,0x03,0x25,\
0x00,0x00,0x00,0x00,0x00,0x03,0x64,0x32,\
0x00,0x00,0x00,0x1D,0x89,0x94,0x45,0x02,\
0x07,0x00,0x00,0x04,0x97,0x22,0x00,0x78,\
0x2E,0x00,0x63,0x3F,0x00,0x57,0x57,0x00,\
0x54,0x76,0x00,0x54,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
...
0x16,0x00,0x02,0x04,0x06,0x08,0x0A,0x0C,\
0x0F,0x10,0x12,0x13,0x14,0xFF,0xFF,0xFF,\
0x00,0x00,0x00,0x33,0x33,0x33,0x33,0x23,\
0x22,0x22,0x22,0x22,0x22,0x11,0xF1,0xFF,\
0x09,0x01\
    }
...
u16 max_limit_value = 2400;     // screen max limit
u16 min_limit_value = 1300;     // screen min limit
