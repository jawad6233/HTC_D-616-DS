...
typedef struct
{
	...
	#define OV8858_IMAGE_SENSOR_FULL_HEIGHT 				(2448)
...
//TODO~
	...
	#define OV8858_VIDEO_PERIOD_PIXEL_NUMS				(1928)//0x0788	//1928
	#define OV8858_VIDEO_PERIOD_LINE_NUMS				(1244)//0x04DC	//1244

	#define OV8858_FULL_PERIOD_PIXEL_NUMS				(1940)//0x794	
