...
static void init_lcm_registers_truly(void)
{
    ...
    data_array[1] = 0x070001B1; //send one param for test
...
static unsigned int lcm_compare_id(void)
{
    ...
    if(LCM_TYPE_TRULY_50_INCH == lcm_type)
		return 1;
	else
		return 0;
}
...
LCM_DRIVER hx8394a_hd720_dsi_vdo_lcm_drv_truly = 
{
    .name		    = "hx8394a_hd720_dsi_vdo_lcm_truly",
