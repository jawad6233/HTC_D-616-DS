...
static struct i2c_board_info __initdata kd_lens_dev={ I2C_BOARD_INFO("BU6424AF", 0x19)};
...
{
    int  i4RetValue = 0;
		//char puSendCmd[2] = {(char)(((a_u2Data >> 8) & 0x03) | 0xc0), (char)(a_u2Data & 0xff)};//jin bu6424
		char puSendCmd[2] = {0xC4 + (char)(a_u2Data >> 8) , (char)a_u2Data};//jin add for bu64241
...
#else
char puSendCmd1[2]={(char)(0x94),(char)(0x78)};//A point=120d
char puSendCmd2[2]={(char)(0x9C),(char)(0xB2)};//B point=178d
char puSendCmd3[2]={(char)(0xA4),(char)(0xE4)};//A-B point step mode:200us/7Lsd 
char puSendCmd4[2]={(char)(0x8C),(char)(0x3b)};//80Hz,Fastest mode
...
static int BU6424AF_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	g_pstBU6424AF_I2Cclient->addr = 0x18;//add
