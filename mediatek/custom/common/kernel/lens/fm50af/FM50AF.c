...
//+Type_Other jinzengwen.wt 20140409 enable SRC function
static int s4FM50AF_WriteRegData(char addr,char data)
{
    int  i4RetValue = 0;
...
//+Type_Other jinzengwen.wt 20140409 enable SRC function
	if(s4FM50AF_WriteRegData(0xEC,0xA3)){
		FM50AFDB("[FM50AF] FM50AF_Open enable SRC fail!\n");
	}
	if(s4FM50AF_WriteRegData(0xF2,0x00)){
		FM50AFDB("[FM50AF] FM50AF_Open enable SRC fail!\n");
	}
	if(s4FM50AF_WriteRegData(0xA1,0x0D)){;
		FM50AFDB("[FM50AF] FM50AF_Open enable SRC fail!\n");
	}
	if(s4FM50AF_WriteRegData(0xDC,0x51)){;
		FM50AFDB("[FM50AF] FM50AF_Open enable SRC fail!\n");
	}
//-Type_Other jinzengwen.wt 20140409 enable SRC function
    spin_lock(&g_FM50AF_SpinLock);
