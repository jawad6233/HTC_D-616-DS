...
char emmc_device_name[30];//wingtech wangfuqiang add for get EMMC flash info
...
void mt_fixup(struct tag *tags, char **cmdline, struct meminfo *mi)
{
	...
	//wingtech wangfuqiang add  for get EMMC flash info add begin 
	char *p;
	char *q;
	char *temp_cmdline;
    //wingtech wangfuqiang add for get EMMC flash info add end
    ...
    */
	...
	char *br_ptr;
		...
		//wingtech wangfuqiang for get EMMC flash info add begin
		...
		//wingtech wangfuqiang for get EMMC flash info add end
...
static struct platform_device actuator1_dev = {
	.name		  = "lens_actuator1",
	.id		  = -1,
};
...
#if defined(WT_BU52051NVX_MHALL_SUPPORT)
...
//=======================================================================
    ...
    retval = platform_device_register(&actuator1_dev);
    if (retval != 0){
        return retval;
    }
#endif
