...
#define NT9252_TEST_PATTERN_CHECKSUM (0x7eb1cf9e)
...
void NT99252_Initial_Setting(void)
{
  NT99252_write_cmos_sensor(0x32f0,0x02); 
	...
	NT99252_write_cmos_sensor(0x306a,0x04); //driving   //0x03                            
  ...
  NT99252_write_cmos_sensor(0x3291,0x58); // init AWB                             
  NT99252_write_cmos_sensor(0x3296,0x01); // init B_AWB                           
  NT99252_write_cmos_sensor(0x3297,0x60); // init AWB  
                                          	            
	NT99252_write_cmos_sensor(0x3127,0x01);  //Lsc_80_ZQ          
	NT99252_write_cmos_sensor(0x3210,0x23);  //Gain0 of R                           
	NT99252_write_cmos_sensor(0x3211,0x2B);  //0x27//Gain1 of R                           
	...
	NT99252_write_cmos_sensor(0x3215,0x22);  //0x1d//Gain1 of Gr                          
	...
	NT99252_write_cmos_sensor(0x3219,0x22); //0x1d //Gain1 of Gb                          
	...
	NT99252_write_cmos_sensor(0x321D,0x1E);  //0x18//Gain1 of B                           
  ...
  NT99252_write_cmos_sensor(0x3234,0x08);                                         
	NT99252_write_cmos_sensor(0x3235,0x08);                                         
	NT99252_write_cmos_sensor(0x3236,0x08);                                         
	NT99252_write_cmos_sensor(0x3237,0x08);                                         
	...
	NT99252_write_cmos_sensor(0x3303, 0x3C);
	NT99252_write_cmos_sensor(0x3304, 0x00);
	NT99252_write_cmos_sensor(0x3305, 0x9D);
	NT99252_write_cmos_sensor(0x3306, 0x00);
	NT99252_write_cmos_sensor(0x3307, 0x24);
	NT99252_write_cmos_sensor(0x3308, 0x07);
	NT99252_write_cmos_sensor(0x3309, 0xBA);
	NT99252_write_cmos_sensor(0x330A, 0x07);
	NT99252_write_cmos_sensor(0x330B, 0x23);
	NT99252_write_cmos_sensor(0x330C, 0x01);
	NT99252_write_cmos_sensor(0x330D, 0x24);
	NT99252_write_cmos_sensor(0x330E, 0x00);
	NT99252_write_cmos_sensor(0x330F, 0xFF);
	NT99252_write_cmos_sensor(0x3310, 0x07);
	NT99252_write_cmos_sensor(0x3311, 0x07);
	NT99252_write_cmos_sensor(0x3312, 0x07);
	NT99252_write_cmos_sensor(0x3313, 0xFA);
    ...
    NT99252_write_cmos_sensor(0x3250, 0x01);//(0x3250,0x01);  //CA_CHT834B                       0314 HTC Maurice  (98518)                      
	NT99252_write_cmos_sensor(0x3251, 0x50);//(0x3251,0xAA);//0xcc  //                                  
	...
	//NT99252_write_cmos_sensor(0x3254, 0xD0);//(0x3254,0xb1);  //0x70                                    
	NT99252_write_cmos_sensor(0x3254, 0xE0);
	NT99252_write_cmos_sensor(0x3255, 0x62);//(0x3255,0x54);  //0x3a Bottom boundary of B / G           
	NT99252_write_cmos_sensor(0x3256, 0x70);//(0x3256,0x70);  //Top boundary of luminance        0314 HTC Maurice  (98518)             
	NT99252_write_cmos_sensor(0x3257, 0x10);  
	NT99252_write_cmos_sensor(0x3258, 0x04); //20131018
	...
	NT99252_write_cmos_sensor(0x32A2, 0xA2); //0x91                                     
	NT99252_write_cmos_sensor(0x32A3, 0x01);                                            
	//NT99252_write_cmos_sensor(0x32A4, 0x45); //0x46                                     
	NT99252_write_cmos_sensor(0x32A4, 0x80);
	NT99252_write_cmos_sensor(0x32A5, 0x01);                                            
	NT99252_write_cmos_sensor(0x32A6, 0x32);                                            
	NT99252_write_cmos_sensor(0x32A7, 0x02);                                            
	NT99252_write_cmos_sensor(0x32A8, 0x46);                                            
	//NT99252_write_cmos_sensor(0x32A9, 0x21); 
	NT99252_write_cmos_sensor(0x32A9, 0x11); 
  ...
  NT99252_write_cmos_sensor(0x32B0,0x44); //Center AE                                                                       
  NT99252_write_cmos_sensor(0x32B1,0xbb);                                         
  NT99252_write_cmos_sensor(0x32B2,0x18); //0x14                                      
}
...
{    
	...
	NT99252_write_cmos_sensor(0x3326,0x12); 
	NT99252_write_cmos_sensor(0x3331,0x0A); 
	NT99252_write_cmos_sensor(0x3332,0xF0);
	NT99252_write_cmos_sensor(0x3368,0x38); // Edge Enhance                         
	NT99252_write_cmos_sensor(0x3369,0x28);                                         
	NT99252_write_cmos_sensor(0x336A,0x20);                                         
	...
	NT99252_write_cmos_sensor(0x337B,0x0A);                                         
	NT99252_write_cmos_sensor(0x337C,0x0A);                                         
	NT99252_write_cmos_sensor(0x3371,0x3f); // NR_Weight                            
  ...
  //[YUYV_1600x1200_10-12fps_60M_2000line]
	...
	NT99252_write_cmos_sensor(0x32B8, 0x42); 
	NT99252_write_cmos_sensor(0x32B9, 0x32); 
	NT99252_write_cmos_sensor(0x32BC, 0x3A); 
	NT99252_write_cmos_sensor(0x32BD, 0x3E); 
	NT99252_write_cmos_sensor(0x32BE, 0x36); 
...
//NT99252_write_cmos_sensor(0x32C4, 0x1E); 
	NT99252_write_cmos_sensor(0x32C5, 0x1E); 
	NT99252_write_cmos_sensor(0x32C6, 0x1E); 
...
static void NT99252_video(void)
{
	...
	NT99252_write_cmos_sensor(0x32f8,0x01);	
  #if 0 //1:video_15fps;  0:video_30fps
  //[YUYV_800x600_15fps_48M  line2500]	
	NT99252_write_cmos_sensor(0x334A, 0x00); 
	NT99252_write_cmos_sensor(0x334b, 0x7f); 
	NT99252_write_cmos_sensor(0x334c, 0x1f);
	...
	NT99252_write_cmos_sensor(0x32BE, 0x36); 
	NT99252_write_cmos_sensor(0x32BF, 0x60); 
	NT99252_write_cmos_sensor(0x32C0, 0x6A); 
	NT99252_write_cmos_sensor(0x32C1, 0x6A); 
	NT99252_write_cmos_sensor(0x32C2, 0x6A); 
	NT99252_write_cmos_sensor(0x32C3, 0x00); 
	NT99252_write_cmos_sensor(0x32C4, 0x20); 
	NT99252_write_cmos_sensor(0x32C5, 0x20); 
	NT99252_write_cmos_sensor(0x32C6, 0x20); 
	NT99252_write_cmos_sensor(0x32C7, 0x00); 
	NT99252_write_cmos_sensor(0x32C8, 0x60); 
	NT99252_write_cmos_sensor(0x32C9, 0x6A); 
	NT99252_write_cmos_sensor(0x32CA, 0x8A); 
	NT99252_write_cmos_sensor(0x32CB, 0x8A); 
	NT99252_write_cmos_sensor(0x32CC, 0x8A); 
	NT99252_write_cmos_sensor(0x32CD, 0x8A); 
	NT99252_write_cmos_sensor(0x32DB, 0x68);  //AE End
	NT99252_write_cmos_sensor(0x3241, 0x79); 
	NT99252_write_cmos_sensor(0x33A0, 0x90); //0xA8
	NT99252_write_cmos_sensor(0x33A1, 0x4A); 
	NT99252_write_cmos_sensor(0x32E0, 0x03);  //Scale Start
  ...
  NT99252_write_cmos_sensor(0x302A, 0x00);  //PLL Start
	...
	NT99252_write_cmos_sensor(0x302D, 0x02);  //PLL End
	NT99252_write_cmos_sensor(0x3022, 0x24);  //Timing Start
	...
	NT99252_write_cmos_sensor(0x3008, 0x04); 
	NT99252_write_cmos_sensor(0x3009, 0xCC); 
	NT99252_write_cmos_sensor(0x300A, 0x09); 
	NT99252_write_cmos_sensor(0x300B, 0xC4); 
	NT99252_write_cmos_sensor(0x300C, 0x02); 
	NT99252_write_cmos_sensor(0x300D, 0x80); 
	NT99252_write_cmos_sensor(0x300E, 0x06); 
	NT99252_write_cmos_sensor(0x300F, 0x40); 
	NT99252_write_cmos_sensor(0x3010, 0x02); 
	NT99252_write_cmos_sensor(0x3011, 0x58);  //Timing End
	NT99252_write_cmos_sensor(0x325C, 0x03); 
    ...
    { 
        ...
        case SCENE_MODE_PORTRAIT:	
            ...
            //chroma component
  			NT99252_write_cmos_sensor(0x32F3, 0x80);
  			//AWB offset 
            NT99252_write_cmos_sensor(0x32A9, 0x64);
        ...
        case SCENE_MODE_LANDSCAPE:
        	...
        	//chroma component
  			...
  			//AWB offset 
            NT99252_write_cmos_sensor(0x32A9, 0x34);
        ...
        case SCENE_MODE_SUNSET:
        	...
        	//chroma component
  			...
  			//AWB offset 
            NT99252_write_cmos_sensor(0x32A9, 0x13);
            NT99252_write_cmos_sensor(0x32AA, 0x01); 
            NT99252_write_cmos_sensor(0x32f8, 0x01);
            break;
        case SCENE_MODE_HDR:
