...
/* For ps calibration */
#define CUST_LTR553_PS_THRES_CLOSE		38	 // Close 
...
#define CUST_LTR553_PS_LED				0x6F // PS LED setting					//50mA, 50%, 60kHz 
#define CUST_LTR553_PS_N_PULSES			0x02 // PS number of pulses				//Number of pulses = 10 
...
#define CUST_LTR553_ALS_CONTR_ENABLE	0x09 // ALS operation mode control SW reset	 //Gain 8X -> 0.125lux to 8k lux
